  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Welcome to Dark Hedron DAO</h1>
...
if (hasClaimedNFT) {
  return (
    <div className="member-page">
      <h2>Dark Hedron DAO Member Page</h2>
      <p>Congratulations on being part of Dark Hedron DAO</p>
      <div>
          <div>
            <h2>Member List</h2>
  ...
  return (
    <div className="mint-nft">
      <h1> Mint your free  Dark Hedron DAO Membership NFT</h1>
      <button
        disabled={isClaiming}
        onClick={() => {
          setIsClaiming(true);
